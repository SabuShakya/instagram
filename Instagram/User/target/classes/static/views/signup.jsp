<form name="signupform" ng-submit="createUser()" novalidate>
    <div>
        <p>
            FirstName:
        ...
        <p>
            Email:
            <input type="text" name="email" ng-model="email" placeholder="Email ID" required/>
    ...
    <button type="submit" ng-click="createUser()" ng-disabled="(signupform.uname.$dirty && signupform.uname.$invalid)
